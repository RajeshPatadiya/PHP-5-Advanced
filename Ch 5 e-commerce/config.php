...
if ($local) {
    ...
    define ('BASE_URI', '/Users/danielehrlich1/Sites/GitHub/PHP-5-Advanced/');
    define ('BASE_URL',	'http://127.0.0.1/~danielehrlich1/GitHub/PHP-5-Advanced/Ch%205%20e-commerce/');
...
$dbc = @mysqli_connect ('localhost', 'root', 'yourpasswordhere', 'ecommerce') OR trigger_error("Could not connect to the database!\n<br />MySQL Error: " . mysqli_connect_error());
